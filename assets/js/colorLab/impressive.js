...
histogram.prototype.width = function(){ return this.length; };
histogram.prototype.height = function(){ return this[0].length; };
...
histogram.prototype.pickPeaks = function pick2DPeaks(){
    var peaks = [];
    for(var x = 0; x < this.width; ++x){
        for(var y =0; y< this.height; ++y){
            if(isPeak(x,y)){
